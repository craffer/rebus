...
- `crates/xword-parser/` — Standalone Rust crate for parsing .puz, .ipuz, .jpz files
...
### Key Types
- `Puzzle`, `Cell`, `Clue` defined in `crates/xword-parser/src/types.rs` (Rust) and mirrored in `src/types/puzzle.ts` (TypeScript)
